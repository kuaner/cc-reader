...
struct TimelineHostView: NSViewRepresentable, Equatable {
    ...
    final class Coordinator: NSObject, WKNavigationDelegate {
        ...
        func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
            ...
            guard url.scheme == "ccreader" else {
        ...
        private func makeDocumentHTML() -> String {
            ...
            let loadOlderHTML = hasOlder ? "<div class=\"topbar\"><a class=\"pill\" href=\"ccreader://load-older\">\(escapeHTML(labels.loadOlder))</a></div>" : ""
            ...
            <script>
                ...
                window.addEventListener('load', function() {
                    ...
                    function emitFollowingStateIfNeeded() {
                        ...
                        window.location.href = 'ccreader://scroll-state?following=' + (following ? '1' : '0');
                    }
                    ...
                    function maybeLoadOlderMessages() {
                        ...
                        window.location.href = 'ccreader://load-older-auto';
                    }
